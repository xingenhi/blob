...
export default {
    ...
    themeConfig: {
        ...
        footer: {
            message: '基于 MIT 许可发布',
            copyright: `版权所有 © 2019-${new Date().getFullYear()} xingenhi`
        },
        docFooter: {
            prev: '上一页',
            next: '下一页'
...
function nav(): DefaultTheme.NavItem[] {
    return [
        ...
        {text: 'Github', link: 'https://github.com/xingenhi/blob.git'},
        {text: 'Gitee', link: 'https://gitee.com/xingenhi/blob.git'},
    ]
}
...
function sidebarLinks(): DefaultTheme.SidebarItem[] {
    return [
