...
![image](https://picgo.xingenhi.cn//typora2279594-4b865f2a2c271def.png)
...
![image](https://picgo.xingenhi.cn//typoraLusifer2018060105410001.png)

**刷新之前项目中的全部测试接口（刷多几次）**

点击 `Find a trace`，可以看到具体服务相互调用的数据

![image](https://picgo.xingenhi.cn//typoraLusifer2018060105410002.png)

点击 `Dependencies`，可以发现服务的依赖关系

![image](https://picgo.xingenhi.cn//typoraLusifer2018060105410003.png)
